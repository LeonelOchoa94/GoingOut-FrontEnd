...
// import PlaceMap from '../components/pages/occupation/PlaceMap';
import Tables from '../components/pages/occupation/Tables';
    ...
    return (
        <div>
            <Routes>
                ...
                <Route path='/ocupacion-mesas' element={<Tables />} />
                {/* </DndProvider> */}
